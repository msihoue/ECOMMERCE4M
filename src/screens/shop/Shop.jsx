...
import Star from '../../components/nav/forms/Star';
        ...
        <div className={styles.box}>
            <div className={styles.sidebar}>
                <div className={styles.heading}>
                    <div className={styles.title}>search/filter menu</div>
                </div>
                <hr />
                <div className={styles.menu}>
                    <Menu
                        ...
                        <SubMenu
                            key="1"
                            title={<span className="h6">Price FCFA</span>}>
                            <div>
                                <Slider
                                    className="ml-4 mr-4"
                                    tipFormatter={v => `${v} FCFA`}
                                    range
                                    value={price}
                        ...
                        <SubMenu
                            key="3"
                            title={<span className="h6">Rating</span>}>
                            <div style={{ marginTop: '-10px' }}>
                                {showStars()}
                            </div>
                        </SubMenu>
